...
final class ResponseMessage {
  ...
  static const String NOT_AVAILABLE =
      "Resource Not Available"; // Failure, resource not found
  static const String SPAMMED =
      "Validation failed, or the endpoint has been spammed"; // Failure, resource not found
...
final class ResponseCode {
  ...
  static const int NOT_AVAILABLE = 301; // Moved permanently
  static const int BAD_REQUEST = 400; // failure, API rejected request
  static const int UNAUTORISED = 401; // failure, user is not authorised
  static const int FORBIDDEN = 403; //  failure, API rejected request
  static const int NOT_FOUND = 404; // failure, not found
  static const int SPAMMED =
